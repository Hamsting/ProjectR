    ...
    public class GameTest : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            */
            ...
            BeatManager.Instance.AddNewBPMInfo( 5, 48.0f, 150.0f, true);
            ...
            BeatManager.Instance.AddNewBPMInfo(17, 48.0f, 120.0f, true);
            ...
            */
            ...
            BeatManager.Instance.AddNewBPMInfo( 0, 0.0f, 240.0f);
            BeatManager.Instance.AddNewBPMInfo( 2, 0.0f, 240.0f, true);
            BeatManager.Instance.AddNewBPMInfo( 4, 0.0f, 240.0f);
            BeatManager.Instance.AddNewBPMInfo( 6, 0.0f, 240.0f, true);
            BeatManager.Instance.AddNewBPMInfo( 8, 0.0f, 240.0f);
            BeatManager.Instance.AddNewBPMInfo(10, 0.0f, 240.0f, true);
            BeatManager.Instance.AddNewBPMInfo(12, 0.0f, 240.0f);
            BeatManager.Instance.AddNewBPMInfo(14, 0.0f, 240.0f, true);
            BeatManager.Instance.AddNewBPMInfo(16, 0.0f, 240.0f);
